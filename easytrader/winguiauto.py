...
def findSubWindows(windows, numChildWindows):
    ...
    for window in windows:
        ...
        #             # for hwnd2, text_name2, class_name2 in dumpWindows(hwnd1):
        #             #     print text_name2.decode("gbk")
        #     except:
        #         continue
...
def closePopupWindow(top_hwnd, wantedText=None, wantedClass=None):
    ...
    if windows[0][1].decode("gbk") == u"提示":
        ...
        clickOnVerticalTimes(left, top, right, bottom, 0.5, 0.9, 8)
        time.sleep(5)
...
def clickOnVerticalTimes(left, top, right, bottom, up_limit, down_limit, times):
    width = right - left
    height = bottom - top
